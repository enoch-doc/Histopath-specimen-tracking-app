...
export default function SpecimenRegistrationScreen({ navigation }) {
  ...
  const validateForm = () => {
    ...
    // Smart validation: Check if STAT/Urgent without clinical notes
          ...
          <View style={styles.priorityContainer}>
            ...
            >
              <View style={styles.priorityHeader}>
                <View>
                  ...
                  {/* <Text style={styles.priorityTime}>Standard turnaround</Text> */}
                </View>
                {!isUrgent && !isStat && (
              ...
              <Text style={styles.priorityDescription}>
                Standard processing with normal turnaround time
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                if (!isUrgent) setIsStat(false);
              }}
              activeOpacity={0.7}
            >
              <View style={styles.priorityHeader}>
                <View>
                  <Text style={[styles.priorityLabel, isUrgent && !isStat && styles.priorityLabelActive]}>
                    URGENT
                  </Text>
              ...
              <Text style={styles.priorityDescription}>
                Requires expedited processing and faster turnaround time
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                setIsStat(!isStat);
                if (!isStat) setIsUrgent(false);
              }}
              activeOpacity={0.7}
            >
              <View style={styles.priorityHeader}>
                <View>
                  <Text style={[styles.priorityLabel, isStat && styles.priorityLabelStatActive]}>
                    STAT
                  </Text>
              ...
              <Text style={styles.priorityDescription}>
                Critical specimen requiring immediate processing and reporting
              </Text>
            </TouchableOpacity>
          </View>
        </View>
